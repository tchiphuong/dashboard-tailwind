...
!(function (e) {
    ...
    (e = window.kendo.jQuery),
        kendo.ui.FlatColorPicker &&
            (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.ColorPicker &&
            (kendo.ui.ColorPicker.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.DateRangePicker &&
            (kendo.ui.DateRangePicker.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.Editor &&
            (kendo.ui.Editor.prototype.options.messages = e.extend(
                ...
                kendo.ui.Editor.prototype.options.messages,
                {
                    ...
                    orderByName: "Tên",
                    invalidFileType:
                        'Tập tin được chọn "{0}" là không hợp lệ. Các kiểu tập tin được hỗ trợ là {1}.',
                    deleteFile: 'Bạn có thật sự muốn xóa "{0}" không?',
                    overwriteFile:
                        'Một tập tin có tên "{0}" đã tồn tại tại thư mục hiện tại. Bạn có muốn ghi đè nó không?',
                    directoryNotFound:
                        "Không tồn tại thư mục có tên nhưu thế này.",
        ...
        kendo.ui.FileBrowser &&
            (kendo.ui.FileBrowser.prototype.options.messages = e.extend(
                !0,
                kendo.ui.FileBrowser.prototype.options.messages,
                {
                    ...
                    orderBySize: "Kích thước",
                    directoryNotFound:
                        "Một thư mục có tên như thế này đã tồn tại.",
                    emptyFolder: "Thư mục rỗng",
                    deleteFile: 'Bạn có thực sự muốn xóa "{0}" không?',
                    invalidFileType:
                        'Tập tin được chọn "{0}" không hợp lệ. Các kiểu tập tin được hỗ trợ là {1}.',
                    overwriteFile:
                        'Một tập tin có tên "{0}" đã tồn tại ở thư mục hiện tại. Bạn có muốn ghi đè nó không?',
        ...
        kendo.ui.FilterMultiCheck &&
            (kendo.ui.FilterMultiCheck.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.Gantt &&
            (kendo.ui.Gantt.prototype.options.messages = e.extend(
                !0,
            ...
            (kendo.ui.Grid.prototype.options.messages = e.extend(
                ...
                kendo.ui.Grid.prototype.options.messages,
                {
                    ...
                    editable: {
                        cancelDelete: "Hủy",
                        confirmation:
                            "Bạn có thật sự muốn xóa bản ghi này không?",
                        confirmDelete: "Xóa",
                    },
                    noRecords: "Không có bản ghi nào sẵn có.",
                    expandCollapseColumnHeader: "",
                    groupHeader:
                        "Bấm tổ hợp phím Ctrl + Space để nhóm lại với nhau",
                    ungroupHeader:
                        "Bấm tổ hợp phím Ctrl + Space để tách ra khỏi nhóm",
                },
            )),
        kendo.ui.TreeList &&
            (kendo.ui.TreeList.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.NumericTextBox &&
            (kendo.ui.NumericTextBox.prototype.options = e.extend(
                !0,
                kendo.ui.NumericTextBox.prototype.options,
                { upArrowText: "Tăng giá trị", downArrowText: "Giảm giá trị" },
            )),
        kendo.ui.MediaPlayer &&
            (kendo.ui.MediaPlayer.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.TreeListPager &&
            (kendo.ui.TreeListPager.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.PivotGrid &&
            (kendo.ui.PivotGrid.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.PivotFieldMenu &&
            (kendo.ui.PivotFieldMenu.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.Scheduler &&
            (kendo.ui.Scheduler.prototype.options.messages = e.extend(
                ...
                kendo.ui.Scheduler.prototype.options.messages,
                {
                    ...
                    editable: {
                        confirmation:
                            "Bạn có thật sự muốn xóa sự kiện này không?",
                    },
                    views: {
                        day: "Ngày",
                        week: "Tuần",
                    ...
                    recurrenceMessages: {
                        ...
                        deleteSeriesConfirmation:
                            "Bạn có thực sự muốn xóa bỏ toàn bộ chuỗi này?",
                        editWindowTitle: "Sửa các mục định kỳ",
                        editWindowOccurrence: "Sửa sự xuất hiện hiện tại",
                        editWindowSeries: "Sửa chuỗi",
                        deleteRecurring:
                            "Bạn muốn xóa chỉ sự kiện này hay toàn bộ chuỗi?",
                        editRecurring:
                            "Bạn muốn sửa chỉ sự kiện này hay toàn bộ chuỗi?",
                    },
                    editor: {
                        title: "Tiêu đề",
                        start: "Bắt đầu",
                        ...
                        separateTimezones:
                            "Sử dụng múi giờ bắt đầu vào múi giờ kết thúc khác nhau",
        ...
        kendo.spreadsheet &&
            ...
            (kendo.spreadsheet.messages.borderPalette = e.extend(
                !0,
                kendo.spreadsheet.messages.borderPalette,
                {
        ...
        kendo.spreadsheet &&
            ...
            (kendo.spreadsheet.messages.dialogs = e.extend(
                !0,
                kendo.spreadsheet.messages.dialogs,
                {
                    apply: "Áp dụng",
                    ...
                    validationDialog: {
                        ...
                        hintMessage:
                            "Vui lòng nhập một {0} hợp lệ có giá trị {1}.",
                    ...
                    modifyMergedDialog: {
                        errorMessage:
                            "Không thể thay đổi từng phần của ô được trộn.",
                    },
                    useKeyboardDialog: {
                        title: "Sao chép và dán",
                        errorMessage:
                            "Những thao tác này không thể gọi qua trình đơn. Thay vào đó, vui lòng sử dụng phím tắt:",
                        labels: {
                    ...
                    unsupportedSelectionDialog: {
                        errorMessage:
                            "Thao tác này không thể thực hiện trên nhiều vùng chọn.",
                    },
                    insertCommentDialog: {
                        title: "Chèn ghi chú",
                        labels: {
                    ...
                    insertImageDialog: {
                        ...
                        typeError:
                            "Vui lòng chọn ảnh có kiểu tập tin JPEG, PNG hoặc GIF",
                    },
                },
            )),
        kendo.spreadsheet &&
            kendo.spreadsheet.messages.filterMenu &&
            (kendo.spreadsheet.messages.filterMenu = e.extend(
                !0,
                kendo.spreadsheet.messages.filterMenu,
                {
        ...
        kendo.spreadsheet &&
            ...
            (kendo.spreadsheet.messages.colorPicker = e.extend(
                !0,
                kendo.spreadsheet.messages.colorPicker,
                {
                    reset: "Thiết lập lại màu sắc",
        ...
        kendo.spreadsheet &&
            ...
            (kendo.spreadsheet.messages.toolbar = e.extend(
                !0,
                kendo.spreadsheet.messages.toolbar,
                {
        ...
        kendo.spreadsheet &&
            ...
            (kendo.spreadsheet.messages.view = e.extend(
                !0,
                kendo.spreadsheet.messages.view,
                {
                    errors: {
                        shiftingNonblankCells:
                            "Không thể chèn các ô do nguy cơ mất dữ liệu. Chèn vào vị trí khác hoặc xóa dữ liệu từ cuối trang tính",
                        filterRangeContainingMerges:
                            "Không thể tạo một bộ lọc trong khoảng chứa các vùng trộn.",
                        validationError:
                            "Giá trị bạn nhập vào vi phạm quy tắc dữ liệu phù hợp với ô dữ liệu.",
                    },
                    tabs: {
                        home: "Trang chủ",
                        insert: "Chèn",
        ...
        kendo.ui.Slider &&
            (kendo.ui.Slider.prototype.options = e.extend(
                !0,
                kendo.ui.Slider.prototype.options,
                { increaseButtonTitle: "Tăng", decreaseButtonTitle: "Giảm" },
            )),
        kendo.ui.ListBox &&
            (kendo.ui.ListBox.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.TreeView &&
            (kendo.ui.TreeView.prototype.options.messages = e.extend(
                !0,
        ...
        kendo.ui.Validator &&
            (kendo.ui.Validator.prototype.options.messages = e.extend(
                ...
                kendo.ui.Validator.prototype.options.messages,
                {
                    ...
                    dateCompare:
                        "Ngày kết thúc nên lớn hơn hoặc bằng ngày bắt đầu",
                },
            )),
        kendo.ui.progress &&
            (kendo.ui.progress.messages = e.extend(
                !0,
                kendo.ui.progress.messages,
                { loading: "Đang tải..." },
            )),
        kendo.ui.Dialog &&
            (kendo.ui.Dialog.prototype.options.messages = e.extend(
                !0,
                kendo.ui.Dialog.prototype.options.localization,
                { close: "Đóng" },
            )),
        kendo.ui.Calendar &&
            (kendo.ui.Calendar.prototype.options.messages = e.extend(
                !0,
                kendo.ui.Calendar.prototype.options.messages,
                { weekColumnHeader: "" },
            )),
        kendo.ui.Alert &&
            (kendo.ui.Alert.prototype.options.messages = e.extend(
                !0,
                kendo.ui.Alert.prototype.options.localization,
                { okText: "Đồng ý" },
            )),
        kendo.ui.Confirm &&
            (kendo.ui.Confirm.prototype.options.messages = e.extend(
                !0,
                kendo.ui.Confirm.prototype.options.localization,
                { okText: "Đồng ý", cancel: "Hủy" },
            )),
        kendo.ui.Prompt &&
            (kendo.ui.Prompt.prototype.options.messages = e.extend(
                !0,
                kendo.ui.Prompt.prototype.options.localization,
                { okText: "Đồng ý", cancel: "Hủy" },
            )),
        kendo.ui.DateInput &&
            (kendo.ui.DateInput.prototype.options.messages = e.extend(
                !0,
