!(function (c, M) {
    ...
    function z(c) {
        ...
        for (M = 0; M < z.length; M++) (b /= 60), (a += q(z.charCodeAt(M)) * b);
        return a * p;
    }
    function L(c) {
    ...
    function S(c) {
        ...
        return (
            o && !b.isMoment(c) && E(z) && z.add(o.parse(z), "minutes"),
            z.tz(A),
            z
        );
    }
            ...
            parse: function (c) {
                ...
                for (z = 0; z < n; z++)
                    if (
                        ...
                        (A = a[z + 1]),
                        (o = a[z ? z - 1 : z]),
                        M < A && S.moveAmbiguousForward
                            ? (M = A)
                            : o < M && S.moveInvalidForward && (M = o),
                        b < p[z] - 6e4 * M)
                    )
                        return a[z];
                return a[n];
